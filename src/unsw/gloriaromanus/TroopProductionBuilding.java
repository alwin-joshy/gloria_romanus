...
public class TroopProductionBuilding extends Infrastructure {
    ...
    public TroopProductionBuilding(Faction f) {
        ...
        setDescription("Each Troop Production Building upgrade will allow for more advance and different categories of troops for the faction, spearmen,  missile infantry,  melee cavalry");
