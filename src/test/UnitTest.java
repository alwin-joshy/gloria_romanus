...
public class UnitTest{
    ...
    public void recruitUnitTest(){
        ...
        System.out.println(g.getCurrentFaction().getName());
        g.selectFaction(currentFaction.getName());
        assertNull(currentFaction.getNthProvince(1).getTroopProductionBuilding());
        try {
            currentFaction.getNthProvince(1).build(new TroopProductionBuilding(currentFaction));
        } catch (IOException e) {
            e.printStackTrace();
            System.exit(1);
        }
        g.endTurn();
        assertNotNull(currentFaction.getNthProvince(1).getTroopProductionBuilding());
    }
